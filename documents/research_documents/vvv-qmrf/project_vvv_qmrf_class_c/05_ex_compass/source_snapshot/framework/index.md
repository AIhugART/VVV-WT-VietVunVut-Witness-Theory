...
| E3 | [vvv_qmrf_framework_e03_registration_lock_postulate.md](vvv_qmrf_framework_e03_registration_lock_postulate.md) | Registration Lock Postulate / Tiên đề Khóa Ghi nhận | Defines `V-hat : I_boundary × D → K_R ∪ {k_null}` as the K-side registration-lock function, with EX snapshot synced as compass-only reference. |
