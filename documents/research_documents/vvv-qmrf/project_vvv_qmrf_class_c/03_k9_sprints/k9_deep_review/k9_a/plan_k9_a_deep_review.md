...
- `documents/research_documents/vvv-qmrf/project_vvv_qmrf_class_c/05_ex_compass/` — `N_QM_VVV_00020` (Validated Absence), `N_QM_VVV_00027` (Born Rule Act-Result Identity), `N_QM_VVV_00029` (Retroactive Override), `N_QM_VVV_00032` (Registration Error).
