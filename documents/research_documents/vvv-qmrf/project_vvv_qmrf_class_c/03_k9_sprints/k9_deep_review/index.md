...
| **SOT-2** | K-Space Axiomatization (canonical) | `documents/research_documents/vvv-qmrf/meta_architecture/K_Space_Axiomatization.md` |
| **SOT-3** | K-Space Axiomatization (Class C copy, PEER-SYNC) | `documents/research_documents/vvv-qmrf/project_vvv_qmrf_class_c/01_axiomatization/K_Space_Axiomatization.md` |
