...
| `documents/research_documents/vvv-qmrf/meta_architecture/vvv_qmrf_meta_architecture_registration_layer_formalization.md` | Primary VVV-QMRF symbol registry source | Symbol class, layer, owner, status, and boundary for the research-level registry. |
...
| `documents/research_documents/vvv-qmrf/framework/vvv_qmrf_framework_e01_self_certifying_registration_postulate.md` | E1 source | `σ(M)`, `R̂_svasa`, `M′`, and K-side self-certification boundary. |
| `documents/research_documents/vvv-qmrf/synthesis/vvv_qmrf_synthesis_s1_lambda_registration_natural_interface_lemma.md` | S1-Λ source | `Λ`, `ε(M)`, and symbolization-interface status as lemma/interface. |
| `documents/research_documents/vvv-qmrf/category/vvv_qmrf_category_13_e14_validated_absence_registration.md` | E14 / VAR source | `Π̂_absent^(ℋ_M)`, null result boundary, and validity-gated absence registration. |
