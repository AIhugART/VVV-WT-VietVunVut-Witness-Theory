...
**Target (output A):** `documents/research_documents/vvv-qmrf/meta_architecture/K_Space_Axiomatization_plan.md` (extend; phase 7–12 added).
**Target (output B):** `documents/research_documents/vvv-qmrf/meta_architecture/K_Space_Axiomatization_v3.md` (NEW file — extend Layer 1+2 verbatim from v2.1; add Layer 3–5).
**Target (output C):** `documents/research_documents/vvv-qmrf/meta_architecture/fits/` (NEW directory; Python venv `fits/.venv/`; scripts for Phase 10 numerical fits).
...
```
documents/research_documents/vvv-qmrf/meta_architecture/fits/
...
```powershell
cd documents/research_documents/vvv-qmrf/meta_architecture/fits
python -m venv .venv
...
|---|-----------|-----------|
| 1 | `fits/` location | **CHỐT**: `documents/research_documents/vvv-qmrf/meta_architecture/fits/` |
