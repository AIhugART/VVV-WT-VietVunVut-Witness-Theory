...
- [k_space_structural_analysis.md](file:///c:/Stable_Diffusion/Buddhist_Epistemology_Quantum_Measurement/documents/research_documents/vvv-qmrf/archives/review/k_space_structural_analysis.md) mentions "structure-preserving maps" trong ngữ cảnh category C_{K-space} — vẫn K-to-K.
