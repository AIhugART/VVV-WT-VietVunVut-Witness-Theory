...
| [vvv_qmrf_framework_formal_registration_state_measurement_model.md](file:///c:/Stable_Diffusion/Buddhist_Epistemology_Quantum_Measurement/documents/research_documents/vvv-qmrf/framework/vvv_qmrf_framework_formal_registration_state_measurement_model.md) | Two-level model, mathematical formalism, RCA stack, claim ladder |
| [vvv_qmrf_synthesis_s1_registration_state_update_pipeline.md](file:///c:/Stable_Diffusion/Buddhist_Epistemology_Quantum_Measurement/documents/research_documents/vvv-qmrf/synthesis/vvv_qmrf_synthesis_s1_registration_state_update_pipeline.md) | S1 pipeline: 3-phase registration chain, Lemma S1-Λ, phase formalisms |
