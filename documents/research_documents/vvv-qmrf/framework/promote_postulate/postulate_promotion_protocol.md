...
|---|---|---|
| Candidate RCA | `documents/research_documents/vvv-qmrf/rca/` | `rca_e##_<short_name>.md` |
| Case validation | `documents/research_documents/vvv-qmrf/rca/cases/` | `e##_case_<source_short>.md` |
| Narrow draft | `documents/research_documents/vvv-qmrf/framework/drafts/` | `vvv_qmrf_framework_e##_<short_name>_narrow_draft.md` |
| **Frozen postulate** | `documents/research_documents/vvv-qmrf/framework/` | `vvv_qmrf_framework_e##_<short_name>_postulate.md` |
...
```text
git mv documents/research_documents/vvv-qmrf/framework/drafts/vvv_qmrf_framework_e##_<short_name>_narrow_draft.md \
       documents/research_documents/vvv-qmrf/framework/vvv_qmrf_framework_e##_<short_name>_postulate.md
```
