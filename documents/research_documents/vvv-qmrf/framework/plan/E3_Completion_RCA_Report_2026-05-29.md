...
| File | Purpose |
|------|---------|
| `documents/research_documents/vvv-qmrf/framework/vvv_qmrf_framework_e03_registration_lock_postulate.md` | Canonical E3 completion: [A-E3] separation, P3 distinctness, T6/null boundary, Class D consequences |
...
| `documents/research_documents/vvv-qmrf/framework/plan/E3_Progress_RCA_2026-05-29.md` | Completion update and scoring |
| `documents/research_documents/vvv-qmrf/framework/index.md` | E3 index role updated to reflect formal type signature and boundaries |
| `documents/research_documents/vvv-qmrf-ex/source_snapshot/framework/index.md` | EX snapshot index updated |
| `documents/research_documents/vvv-qmrf/project_vvv_qmrf_class_c/05_ex_compass/source_snapshot/framework/index.md` | Class C EX compass index updated |
| `documents/research_documents/vvv-qmrf/VVV_QMRF_research_terminology.md` | E3 concept trace updated |
| `documents/research_documents/vvv-qmrf/project_vvv_qmrf_class_c/06_references/VVV_QMRF_research_terminology.md` | Class C reference terminology updated |
| `documents/research_documents/vvv-qmrf/archives/plan/E3_Registration_Lock_Formalization_Plan.md` | Deleted per user-selected commit scope option 2 |
