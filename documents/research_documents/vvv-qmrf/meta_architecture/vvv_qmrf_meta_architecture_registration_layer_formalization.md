...
RCA definition decision: this tuple is the minimal formal shape of one VVV-QMRF registration state. It belongs in `documents/research_documents/vvv-qmrf/meta_architecture/` because it defines the architecture of the K-side state itself, not a topic-specific category example or course-level shorthand.
...
RCA definition decision: the complete $U_K$ formula belongs in `documents/research_documents/vvv-qmrf/meta_architecture/` because it defines the conservative K-side update relation that connects the minimal registration-state tuple to post-measurement registration status.
...
RCA definition decision: the complete Self-Certification formula belongs in `documents/research_documents/vvv-qmrf/meta_architecture/` because it defines the closure condition of K-side registration itself. It is not a course-level shorthand and not a category-specific example.
...
RCA definition decision: the complete $M \equiv^K r$ formula belongs in `documents/research_documents/vvv-qmrf/meta_architecture/` because it defines the registration self-completion relation of the K-side architecture. It is not a high-school shorthand and not a category-specific application.
...
RCA definition decision: the complete Validity Function formula set belongs in `documents/research_documents/vvv-qmrf/meta_architecture/` because it defines the validity architecture of K-side registration itself. It is not a high-school shorthand and not a category-specific example.
...
RCA definition decision: the complete pre-symbolic registration formula belongs in `documents/research_documents/vvv-qmrf/meta_architecture/` because it defines the K-side state before symbolic registration is introduced by $\Lambda$.
...
RCA definition decision: the complete $\Lambda$ formula belongs in `documents/research_documents/vvv-qmrf/meta_architecture/` because it defines the K-side transition from pre-symbolic registration to symbolic registered result. It is not a high-school shorthand and not a category-specific example.
...
RCA definition decision: the complete Internal Representation Encoding formula belongs in `documents/research_documents/vvv-qmrf/meta_architecture/` because it defines how symbolic outcome content is encoded inside the K-side registration structure after symbolization.
...
RCA definition decision: the complete Registering-System-as-Process formula belongs in `documents/research_documents/vvv-qmrf/meta_architecture/` because it defines the identity structure of the K-side registering system. It is not a course-level shorthand and not a category-specific example.
...
**RCA placement decision:** This formula belongs in `documents/research_documents/vvv-qmrf/meta_architecture/` because it defines the time structure of the K-side registration layer, not a topic-specific category example or a high-school teaching shorthand.
